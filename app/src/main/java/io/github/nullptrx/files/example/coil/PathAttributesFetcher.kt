...
import io.github.nullptrx.files.example.util.runWithCancellationSignal
import io.github.nullptrx.files.file.MimeType
import io.github.nullptrx.files.file.asMimeType
import io.github.nullptrx.files.file.lastModifiedInstant
...
import io.github.nullptrx.files.extension.setDataSource as appSetDataSource
      ...
      mimeType.isMedia && (path.isLinuxPath || path.isDocumentPath) -> {
        val embeddedPicture = try {
          MediaMetadataRetriever().use { retriever ->
            retriever.appSetDataSource(path)
