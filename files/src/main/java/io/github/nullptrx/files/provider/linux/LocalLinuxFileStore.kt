...
import io.github.nullptrx.files.provider.common.FileStoreNotFoundException
...
import io.github.nullptrx.files.provider.linux.syscall.*
...
internal class LocalLinuxFileStore : PosixFileStore, Parcelable {
  ...
  private constructor(source: Parcel) {
    path = source.readParcelableCompat()!!
    mntent = source.readParcelableCompat()!!
  }
