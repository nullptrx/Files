...
static jclass getSyscallExceptionClass(JNIEnv *env) {
    ...
    if (!syscallExceptionClass) {
        syscallExceptionClass = findClass(env,
                                          "io/github/nullptrx/files/provider/linux/syscall/SyscallException");
    }
...
static jclass getByteStringClass(JNIEnv *env) {
    ...
    if (!byteStringClass) {
        byteStringClass = findClass(env, "io/github/nullptrx/files/provider/common/protobuf/ByteString");
    }
...
static jclass getInt32RefClass(JNIEnv *env) {
    ...
    if (!int32RefClass) {
        int32RefClass = findClass(env, "io/github/nullptrx/files/provider/linux/syscall/Int32Ref");
    }
...
static jclass getStructDirentClass(JNIEnv *env) {
    ...
    if (!structStatClass) {
        structStatClass = findClass(env,
                                    "io/github/nullptrx/files/provider/linux/syscall/StructDirent");
    }
...
static jclass getStructGroupClass(JNIEnv *env) {
    ...
    if (!structGroupClass) {
        structGroupClass = findClass(env,
                                     "io/github/nullptrx/files/provider/linux/syscall/StructGroup");
    }
...
static jclass getStructInotifyEventClass(JNIEnv *env) {
    ...
    if (!structInotifyEventClass) {
        structInotifyEventClass = findClass(env,
                                            "io/github/nullptrx/files/provider/linux/syscall/StructInotifyEvent");
    }
...
static jclass getStructMntentClass(JNIEnv *env) {
    ...
    if (!structMntentClass) {
        structMntentClass = findClass(env,
                                      "io/github/nullptrx/files/provider/linux/syscall/StructMntent");
    }
...
static jfieldID getStructMntentMntOptsField(JNIEnv *env) {
    ...
    if (!structMntentMntOptsField) {
        structMntentMntOptsField = findField(env, getStructMntentClass(env), "mnt_opts",
                                             "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;");
    }
...
static jclass getStructPasswdClass(JNIEnv *env) {
    ...
    if (!structPasswdClass) {
        structPasswdClass = findClass(env,
                                      "io/github/nullptrx/files/provider/linux/syscall/StructPasswd");
    }
...
static jclass getStructStatClass(JNIEnv *env) {
    ...
    if (!structStatClass) {
        structStatClass = findClass(env,
                                    "io/github/nullptrx/files/provider/linux/syscall/StructStat");
    }
    return structStatClass;
}
...
static jclass getStructTimespecClass(JNIEnv *env) {
    ...
    if (!structTimespecClass) {
        structTimespecClass = findClass(env,
                                        "io/github/nullptrx/files/provider/linux/syscall/StructTimespec");
    }
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_access(
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_chmod(
        JNIEnv *env, jclass clazz, jobject javaPath, jint javaMode) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_chown(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_closedir(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_endmntent(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_endgrent(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_endpwent(JNIEnv *env, jclass clazz) {
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_errno(
        JNIEnv *env, jclass clazz) {
    return errno;
}

JNIEXPORT jint JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_fcntl_1int(
...
JNIEXPORT jint JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_fcntl_1void(
...
static jobject newStructGroup(JNIEnv *env, const struct group *group) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructGroupClass(env), "<init>",
                                 "(Lio/github/nullptrx/files/provider/common/protobuf/ByteString;"
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;I"
                                 "[Lio/github/nullptrx/files/provider/common/protobuf/ByteString;)V");
    }
    jobject gr_name;
    if (group->gr_name) {
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getgrent(JNIEnv *env, jclass clazz) {
    while (true) {
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getgrgid(
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getgrnam(
...
static jobject newStructMntent(JNIEnv *env, const struct mntent *mntent) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructMntentClass(env), "<init>",
                                 ...
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;"
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;"
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;II)V");
    }
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getmntent(
        JNIEnv *env, jclass clazz, jlong javaFile) {
    FILE *file = (FILE *) javaFile;
#if __ANDROID_API__ >= __ANDROID_API_L_MR1__
...
static jobject newStructPasswd(JNIEnv *env, const struct passwd *passwd) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructPasswdClass(env), "<init>",
                                 "(Lio/github/nullptrx/files/provider/common/protobuf/ByteString;II"
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;"
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;"
                                 "Lio/github/nullptrx/files/provider/common/protobuf/ByteString;)V");
    }
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getpwent(JNIEnv *env, jclass clazz) {
    while (true) {
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getpwnam(
        JNIEnv *env, jclass clazz, jobject javaName) {
    char *name = mallocStringFromByteString(env, javaName);
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_getpwuid(
...
JNIEXPORT jboolean JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_hasmntopt(
...
JNIEXPORT jint JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_inotify_1add_1watch(
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_inotify_1init1(
...
static jobject newStructInotifyEvent(JNIEnv *env, const struct inotify_event *event) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructInotifyEventClass(env), "<init>",
                                 "(IIILio/github/nullptrx/files/provider/common/protobuf/ByteString;)V");
    }
    jint wd = event->wd;
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_inotify_1get_1events(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_inotify_1rm_1watch(
...
JNIEXPORT jint JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_ioctl_1int(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_lchown(
        JNIEnv *env, jclass clazz, jobject javaPath, jint javaUid, jint javaGid) {
    char *path = mallocStringFromByteString(env, javaPath);
    uid_t uid = (uid_t) javaUid;
    gid_t gid = (gid_t) javaGid;
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_lgetxattr(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_link(
...
JNIEXPORT jobjectArray JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_llistxattr(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_lsetxattr(
...
static jobject newStructStat(JNIEnv *env, const struct stat64 *stat) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructStatClass(env), "<init>", "(JJIJIIJJJJ"
                                                                         "Lio/github/nullptrx/files/provider/linux/syscall/StructTimespec;"
                                                                         "Lio/github/nullptrx/files/provider/linux/syscall/StructTimespec;"
                                                                         "Lio/github/nullptrx/files/provider/linux/syscall/StructTimespec;)V");
    }
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_lstat(
        JNIEnv *env, jclass clazz, jobject javaPath) {
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_lutimens(
        JNIEnv *env, jclass clazz, jobject javaPath, jobjectArray javaTimes) {
    doUtimens(env, javaPath, javaTimes, true);
}

JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_mkdir(
        JNIEnv *env, jclass clazz, jobject javaPath, jint javaMode) {
    char *path = mallocStringFromByteString(env, javaPath);
    mode_t mode = (mode_t) javaMode;
...
JNIEXPORT jint JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_mount(
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_open(
...
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_opendir(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
static jobject newStructDirent(JNIEnv *env, const struct dirent64 *dirent) {
    ...
    if (!constructor) {
        constructor = findMethod(env, getStructDirentClass(env), "<init>",
                                 "(JJIILio/github/nullptrx/files/provider/common/protobuf/ByteString;)V");
    }
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_readdir(
        JNIEnv *env, jclass clazz, jlong javaDir) {
    DIR *dir = (DIR *) javaDir;
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_readlink(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_realpath(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_remove(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_rename(
        JNIEnv *env, jclass clazz, jobject javaOldPath, jobject javaNewPath) {
    char *oldPath = mallocStringFromByteString(env, javaOldPath);
    char *newPath = mallocStringFromByteString(env, javaNewPath);
...
JNIEXPORT jlong JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_sendfile(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_setgrent(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlong JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_setmntent(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_setpwent(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_stat(
        JNIEnv *env, jclass clazz, jobject javaPath) {
...
JNIEXPORT jobject JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_statvfs(
        JNIEnv *env, jclass clazz, jobject javaPath) {
    char *path = mallocStringFromByteString(env, javaPath);
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_symlink(
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_files_provider_linux_syscall_Syscalls_utimens(
        JNIEnv *env, jclass clazz, jobject javaPath, jobjectArray javaTimes) {
