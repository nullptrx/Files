...
Java_io_github_nullptrx_libselinux_SeLinux_fgetfilecon(
...
Java_io_github_nullptrx_libselinux_SeLinux_fsetfilecon(
...
JNIEXPORT jbyteArray JNICALL
Java_io_github_nullptrx_libselinux_SeLinux_getfilecon(
        JNIEnv *env, jclass clazz, jbyteArray javaPath) {
    return doGetfilecon(env, javaPath, false);
}

JNIEXPORT jboolean JNICALL
Java_io_github_nullptrx_libselinux_SeLinux_is_1selinux_1enabled(
...
JNIEXPORT jbyteArray JNICALL
Java_io_github_nullptrx_libselinux_SeLinux_lgetfilecon(
        JNIEnv *env, jclass clazz, jbyteArray javaPath) {
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_libselinux_SeLinux_lsetfilecon(
        JNIEnv *env, jclass clazz, jbyteArray javaPath, jbyteArray javaContext) {
    doSetfilecon(env, javaPath, javaContext, true);
}

JNIEXPORT jboolean JNICALL
Java_io_github_nullptrx_libselinux_SeLinux_security_1getenforce(
        JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_io_github_nullptrx_libselinux_SeLinux_setfilecon(
        JNIEnv *env, jclass clazz, jbyteArray javaPath, jbyteArray javaContext) {
